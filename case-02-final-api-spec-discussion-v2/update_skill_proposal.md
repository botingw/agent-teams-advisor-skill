...
|---|--------|------|-------------|
| 1 | Quick-start checklist | New section | best-practices.md (top) |
| 2 | Integration testing coordination | New section | best-practices.md |
| 3 | Constraint-ID referencing guidance | Enhancement | best-practices.md |
| 4 | DECISION NEEDED emphasis | Enhancement | best-practices.md |
| 5 | Proposer/Reviewer role clarification | Enhancement | best-practices.md |
| 6 | Inline example guidance for proposals | New subsection | best-practices.md |

All changes are either [GENERIC] (items 1, 3, 4) or [SITUATION: specific context] with clear "Applies to" labels (items 2, 5, 6). No [DOMAIN-SPECIFIC] insights were added.
